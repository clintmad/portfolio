...
export const PROJECTS = [
    ...
    new Project("weather", "Weather and Tech News", "Uses your location to show you the weather. The background changes according to the current weather. News feed with the latest news on tech.", "assets/images/geoweather.png", "https://clintmad.github.io/geoweather/"),
